...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] GameObject arrowPrefab; // Assign in Inspector
    [SerializeField] Transform gunTransform; // Assign the Gun object in Inspector
    bool isAlive = true;
    ...
    void OnFire(InputValue value){
        ...
        if(value.isPressed){
            ...
            Instantiate(arrowPrefab, gunTransform.position, arrowPrefab.transform.rotation);
            arrowPrefab.GetComponent<ShootingLogic>().SetDirection(transform.localScale.x);
        }
    }
